...
public class QuestionnaireHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logArray = new ArrayList<QuestionnaireClassValues>();
        ...
        datepickStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        QuestionnaireHistory.this,R.style.DialogTheme,startDatelistener,year,month,day);
        ...
        datepickEnd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        QuestionnaireHistory.this,R.style.DialogTheme,endDatelistener,year,month,day);
                datePickerDialog.show();
            }
        });
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(startDateString) ){
                    Toast.makeText( QuestionnaireHistory.this, "Please enter a start date and time", Toast.LENGTH_SHORT).show();
                }

                else if(TextUtils.isEmpty(endDateString) ){
                    Toast.makeText( QuestionnaireHistory.this, "Please enter an end date and time", Toast.LENGTH_SHORT).show();
                }
