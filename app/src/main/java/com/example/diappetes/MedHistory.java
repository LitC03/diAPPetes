...
public class MedHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datepickStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        MedHistory.this,R.style.DialogTheme,startDatelistener,year,month,day);
        ...
        datepickEnd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        MedHistory.this,R.style.DialogTheme,endDatelistener,year,month,day);
                datePickerDialog.show();
            }
        });
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(startDateString) ){
                    Toast.makeText( MedHistory.this, "Please enter a start date and time", Toast.LENGTH_SHORT).show();
                }

                else if(TextUtils.isEmpty(endDateString) ){
                    Toast.makeText( MedHistory.this, "Please enter an end date and time", Toast.LENGTH_SHORT).show();
                }
                    ...
                    try {
                        ...
                        db.collection("Patients").document(global.getNhsNum()).collection("MedLog").whereGreaterThan("Time", startTimeStamp).whereLessThan("Time", endTimeStamp)
